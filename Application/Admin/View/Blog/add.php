...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="__PUBLIC__/simditor-2.3.5/styles/font-awesome.css" />
		<link rel="stylesheet" type="text/css" href="__PUBLIC__/simditor-2.3.5/styles/simditor.css" />
		<script type="text/javascript" src="__PUBLIC__/simditor-2.3.5/scripts/module.js"></script>
		<script type="text/javascript" src="__PUBLIC__/simditor-2.3.5/scripts/hotkeys.min.js"></script>
		<script type="text/javascript" src="__PUBLIC__/simditor-2.3.5/scripts/uploader.js"></script>
		<script type="text/javascript" src="__PUBLIC__/simditor-2.3.5/scripts/simditor.js"></script>
